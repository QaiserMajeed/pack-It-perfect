    ...
    return (
      <PageContainer>
        <SEO
          ...
          description="The requested product category could not be found. Explore our other custom packaging solutions."
  ...
  if (!filterProducts) {
    return (
      <PageContainer>
        <SEO
          title="Product Not Found"
          description="The requested product could not be found. Explore our other custom packaging solutions."
          canonicalUrl={location.pathname}
        />
        <div className="alert alert-warning">
...
const generateProductSchema = () => {
  return {
    ...
    "@type": "Product",
    name: filterProducts.title,
    image: filterProducts.image,
    description:
      filterProducts.description ||
      `Premium quality custom ${filterProducts.title.toLowerCase()} packaging solutions.`,
    brand: {
      "@type": "Brand",
  ...
  return (
    <PageContainer>
      <SEO
        ...
        description={
          filterProducts.description ||
          `Premium quality custom ${filterProducts.title.toLowerCase()} packaging solutions. Eco-friendly materials and free design assistance available.`
        }
        canonicalUrl={location.pathname}
        ogImage={filterProducts.image}
        ogType="product"
