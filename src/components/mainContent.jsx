          ...
          <SliderWrapper className="slider-container">
            <ProductSlide className="slide3">
              <ProductCard className="products1">
                <img
                  src="/images/product-slides2-homepage/cerealBoxesSlimSize.webp"
            ...
            <ProductSlide className="slide3">
              <ProductCard className="products1">
                <img
                  src="/images/product-slides2-homepage/book mockups.webp"
                  alt="Book Mockups"
                />
                <ProductButton className="product-button">
                  Book Mockups
            ...
            <ProductSlide className="slide3">
              <ProductCard className="products1">
                <img
                  src="/images/product-slides2-homepage/paperboxespackaging.webp"
            ...
            <ProductSlide className="slide3">
              <ProductCard className="products1">
                <img
                  src="/images/product-slides2-homepage/pillowboxes.webp"
                  alt="Pillow Boxes"
                />
                <ProductButton className="product-button">
                  Pillow Boxes
            ...
            <ProductSlide className="slide3">
              <ProductCard className="products1">
                <img
                  src="/images/product-slides2-homepage/cakeboxes.webp"
                  alt="Cakes Boxes"
                />
                <ProductButton className="product-button">
                  Cakes Boxes
            ...
            <ProductSlide className="slide3">
              <ProductCard className="products1">
                <img
                  src="/images/product-slides2-homepage/Cuuterguider.webp"
                  alt="Cutter Guider"
                />
                <ProductButton className="product-button">
                  Cutter Guider
